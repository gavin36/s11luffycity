...
#     obj = models.Course.objects.filter(id=1).values("degree_course__name")
#     print(obj)

# e.获取id = 1 的专题课，并打印：课程名、级别(中文)、why_study、what_to_study_brief、所有recommend_courses

    # obj = models.Course.objects.filter(id=1).values("coursedetail__why_study","coursedetail__what_to_study_brief", "coursedetail__recommend_courses")
    #
    # print(obj)
# f.获取id = 1 的专题课，并打印该课程相关的所有常见问题
#     obj = models.Course.objects.filter(id=1).first()
#     print(obj.asked_question.all())

# g.获取id = 1 的专题课，并打印该课程相关的课程大纲
#     obj = models.Course.objects.filter(id=1).values("coursedetail__courseoutline__title")
#     print(obj)
# h.获取id = 1 的专题课，并打印该课程相关的所有章节
#     obj = models.Course.objects.filter(id=1).values("coursechapters__chapter")
#     print(obj)
# i.获取id = 1 的专题课，并打印该课程相关的所有课时
